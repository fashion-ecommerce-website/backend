...
public interface PaymentRepository extends JpaRepository<Payment, Long> {
    ...
    @Query(value = "select o.id as order_id, o.total_amount, o.subtotal_amount, o.discount_amount, o.shipping_fee, o.currency, od.title, od.color_label, od.size_label, od.quantity, od.unit_price, od.detail_id "
